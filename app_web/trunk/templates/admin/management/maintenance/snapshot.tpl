    <div class="container" xmlns="http://www.w3.org/1999/html">
        ...
        <div class="row">
            <div class="span12">
                <h2>Snapshots</h2>
                <ul>
                    <li>Generate a snapshot of code and save in home director</li>
                    <li>Generate Snapshot of Data</li>
                    <li>Generate Snapshot of Tmp</li>
                    <li>Generate snapshot of Database</li>
                </ul>
                <div class="form-horizontal" id="branduserForm">
                    <fieldset id="formFields">
                        ...
                        <div id="snapshotAll" class="control-group" style="display:none;">
                            <label class="control-label" for="brandName">Brand Name <br/>Or <a id="useBrandSelection"
                                                                                               href="#">Select a
                                Brand</a></label>

                            <div class="controls">
                                <input id="brandName" data-bind="value:brandName" placeholder="Enter a Brand Name"
                                       class="input-large"/>
                                &nbsp;
                                <button id="brandSubmission" data-bind='click: createBrandOrUserClick'
                                        class="btn btn-primary" style="display:none;">&nbsp;&nbsp;&nbsp;Snapshot &nbsp;&nbsp;&nbsp;</button>
                            </div>
                        </div>
                            {else}
