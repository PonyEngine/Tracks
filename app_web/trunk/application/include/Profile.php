<?php
    abstract class Profile
    {
        ...
        {
            return array_key_exists($name, $this->_properties) ? stripcslashes($this->_properties[$name]['value']) : null;
        }
    	...
    	public function getTotal(){ //change the logic to a simple count
