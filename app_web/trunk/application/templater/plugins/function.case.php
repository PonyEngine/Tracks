...
* @return string
*/
function smarty_function_case($params, $content, &$smarty, &$repeat) {
   ...
   if (is_null($content)) {
      ...
      $testExpression = smarty_function_case_eval($params['expr']);
...
function smarty_function_case_eval($expression='') {
